...
public class Day03_4 {
	...
	public static void main(String[] args) {
		...
		//p.121 예제1
			for( int i = 1 ; i<=10 ; i++) {
				// int = 1 : 초기값 선언 [ i는 반복변수 ]
					// i<=10 :조건식 [ i가 10이하면 실행 아니면 실행 불가
						//i++ : 증감식[ 실행문 실행후 증가 혹은 감소 단위]
				// *변수 i는 1부터 10까지 1씩 증가하면서 실행문 반복처리
				System.out.println( i + "");
					//i=1일때 i<=10 [ true ] 실행문실행 -> 증감식 i=2
					//i=2일때 i<=10 [ true ] 실행문실행 -> 증감식 i=3
					//i=3일때 i<=10 [ true ] 실행문실행 -> 증감식 i=4
					//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
					//i=10일때 i<=10 [ true ] 실행문 -> 증감식 i=11
		...
		//예졔3 : 1부터 100까지 7배수의 누적합계
			int sum3= 0;
			for( int i= 1 i<=100; i++) {
				//배수찾기 값 % 수 == 0이면 그 수의 배수
				if( i % 7 ==0 ) sum3 += i;
